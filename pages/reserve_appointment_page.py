...
class ReserveAppointmentPage(BasePage):
    ...
    def __init__(self, page: Page):
        ...
        self.credit_card_expiration_date = stripe.get_by_role("textbox", name="Expiration date MM / YY")
        self.credit_card_security_code = stripe.get_by_role("textbox", name="Security code")
